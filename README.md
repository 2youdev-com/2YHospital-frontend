...
| الدور | رقم الجوال | الصلاحيات |
|-------|------------|-----------|
| **Admin** — مدير النظام | `+966500000000` | كامل الصلاحيات: لوحة التحكم، الأطباء، المرضى، الفواتير، التقارير |
| **Doctor** — طبيب | `+966511111111` | بوابة الطبيب: الجدول اليومي، ملفات المرضى، الملاحظات، المساعد الذكي |
| **Patient1** — مريض | `+966522222222` | تطبيق المريض: حجز المواعيد، السجل الطبي، الفواتير |
| **Patient2** —  مريض | `+966533333333` | المواعيد، المرضى، الأطباء، الإشعارات |
| **Patient3** — مريض | `+966544444444` | الفواتير، التقارير المالية، الإشعارات |
